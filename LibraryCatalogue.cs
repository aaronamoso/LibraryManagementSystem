    ...
    public static class LibraryCatalogue
    {
        public static List<Book> GetBooks()
        {
            return new List<Book>
            {
                ...
                new Book { Title = "Til We Have Faces", Author = "C.S. Lewis", ISBN = "978-07562641023", PublicationDate = "1956", Genre = "Mythology", Description = "A retelling of the myth of Cupid and Psyche, based on its telling in a chapter of The Golden Ass of Apuleius", ImageName = Image.FromFile("Resources/Faces.jpg") },
